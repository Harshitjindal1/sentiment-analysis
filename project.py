...
def create_app_ui():
    ...
    main_layout = html.Div([
        ...
        html.Div([
            ...
            html.Img(src="assets/Figure 2021-09-18 134818.png",style = {'width': '100px'})
        
            ]),
        
        html.Div([
            html.Img(src="assets/Figure 2021-09-18 140447.png",style = {'width': '100px'})
            ]),
         dbc.Jumbotron(
                [
                    
                    dbc.Textarea(id = 'textarea', className="mb-3", placeholder="Enter the Review", value = 'enter any review for sentiment analysis', style = {'height': '150px'}),
                    dbc.Container([
                        dcc.Dropdown(
                    id='dropdown',
                    placeholder = 'Reviews',
